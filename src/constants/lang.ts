...
const LANG_EN = {
  title: "Who's That Spectrobe?",
  dontknow: "I don't know!",
  generation: 'Game Rosters',
  difficulty: 'Difficulty',
  'difficulty-0': '1: Artwork',
  'difficulty-1': '2: 3D Model',
  'difficulty-2': '3: Coming Soon',
  'difficulty-3': '4: Coming Soon',
  'difficulty-4': '0: Unhidden',
  spelling: 'Spelling',
  ...
  nextpokemon: 'Next Spectrobe in _TIME_ seconds (press Enter to skip)',
  loadfail: 'This is taking a while to load. Do you want to try loading another one? It won\'t affect your streak. <a href="#" id="loadNewPokemonCta">Load a new Spectrobe?</a>',
  slowconn: 'Is your connection slow or down? Maybe try a harder difficulty, they load faster.',
  loadnew: 'Load a new Spectrobe?',
  streakInfo: 'Note: Your streaks and times are separate for each difficulty',
  settingsEffect: 'Your new settings will take effect for the next Spectrobe',
  genfinished: 'There are no Spectrobes left! Why not try a different difficulty? Or you can start again with the same settings. I may add more gamemodes in future updates, feel free to recommend ideas to @AsithDevs on Twitter.',
  ...
  footer: 'Who\'s That Spectrobe game by <a href="https://twitter.com/AsithDevs" title="Asith\'s Twitter" target="_blank">Asith</a>.<br />Images compiled by <a href="https://x.com/AsithDevs" title="Asith\'s Twitter" target="_blank">Asith</a>. Images &copy; Disney.<br />Based on Who\'s That Pokémon by <a href="https://github.com/menardi/whosthatpokemon" title="Who\'s That Pokémon on Github" target="_blank">Menardi</a>.  ',
  language: 'Language',
  settings: 'Settings',
